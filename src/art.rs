// Original Asciiquarium artwork encoded as Rust string constants.
//
...
//
// Byte-exact art from the classic Asciiquarium sources. Every block is a raw
// string so backslashes stay literal. In these sprites '?' is the
